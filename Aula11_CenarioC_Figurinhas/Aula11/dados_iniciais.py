# dados_iniciais.py — popular banco com colecionadores e figurinhas de exemplo

from models import Colecionador, Figurinha, db


def popular_dados():
    """Popula dados iniciais apenas se o banco estiver vazio."""
    if Colecionador.query.count() > 0:
        return  # já populado, pula
